...
public class TemplateService {
    ...
    public void createDefaultTemplates(User user) {
        List<Template> defaultTemplates = List.of(
                new Template(user, "Welcome Email", "Special Offer for Settling Your Invoice",
                        "Dear [Client's Name],\n\n" +
                ...
                new Template(user, "Gentle Reminder Email", "Friendly Reminder: Payment for [Invoice #]",
                        "Dear [Client's Name],\n\n" +
                ...
                new Template(user, "Firm but Polite Follow-Up Email", "Follow-Up: Outstanding Payment for [Invoice #]",
                        "Dear [Client's Name],\n\n" +
                ...
                new Template(user, "Urgent Escalation Email (Final Notice)", "Urgent: Final Reminder for Payment [Invoice #]",
                        "Dear [Client's Name],\n\n" +
